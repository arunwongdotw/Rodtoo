appControllers.controller('adminPaymentDetailCtrl', function($scope, $timeout, $state, $ionicHistory, $mdDialog, $http, myService, $mdSidenav, $cordovaInAppBrowser) {
      ...
      $mdDialog.show({
        ...
        locals: {
          displayOption: {
            ...
            content: "เกิดข้อผิดพลาด getPaymentDetail ใน adminPaymentDetailController ระบบจะปิดอัตโนมัติ",
            ok: "ตกลง"
          }
        }
      }).then(function(response) {
  ...
  $scope.btnBack = function() {
    $scope.navigateTo('loginadmin.adminpaymentlist');
  };
      ...
      .then(function(response) {
        ...
        $mdDialog.show({
          ...
          locals: {
            displayOption: {
              title: "เกิดข้อผิดพลาด !",
              content: "เกิดข้อผิดพลาด getOriginProvince ใน adminPaymentDetailController ระบบจะปิดอัตโนมัติ",
              ok: "ตกลง"
            }
          }
        }).then(function(response) {
      ...
      .then(function(response) {
        ...
        $mdDialog.show({
          ...
          locals: {
            displayOption: {
              title: "เกิดข้อผิดพลาด !",
              content: "เกิดข้อผิดพลาด getOriginDistrict ใน adminPaymentDetailController ระบบจะปิดอัตโนมัติ",
              ok: "ตกลง"
            }
          }
        }).then(function(response) {
      ...
      .then(function(response) {
        ...
        $mdDialog.show({
          ...
          locals: {
            displayOption: {
              title: "เกิดข้อผิดพลาด !",
              content: "เกิดข้อผิดพลาด getDestinationProvince ใน adminPaymentDetailController ระบบจะปิดอัตโนมัติ",
              ok: "ตกลง"
            }
          }
        }).then(function(response) {
      ...
      .then(function(response) {
        ...
        $mdDialog.show({
          ...
          locals: {
            displayOption: {
              title: "เกิดข้อผิดพลาด !",
              content: "เกิดข้อผิดพลาด getDestinationDistrict ใน adminPaymentDetailController ระบบจะปิดอัตโนมัติ",
              ok: "ตกลง"
            }
          }
        }).then(function(response) {
      ...
      .then(function(response) {
        ...
        $mdDialog.show({
          ...
          locals: {
            displayOption: {
              title: "เกิดข้อผิดพลาด !",
              content: "เกิดข้อผิดพลาด getQueueOwner ใน adminPaymentDetailController ระบบจะปิดอัตโนมัติ",
              ok: "ตกลง"
            }
          }
        }).then(function(response) {
    ...
    $mdDialog.show({
      ...
      $http({
        ...
        $mdDialog.show({
          ...
          $http.get(myService.configAPI.webserviceURL + 'php_push/paymentToQueueNotification.php?bookingid=' + booking_id);
          $http.get(myService.configAPI.webserviceURL + 'php_push/paymentToUserNotification.php?bookingid=' + booking_id);
        ...
        $mdDialog.show({
          ...
          locals: {
            displayOption: {
              title: "เกิดข้อผิดพลาด !",
              content: "เกิดข้อผิดพลาด btnConfirmPayment ใน adminPaymentDetailController ระบบจะปิดอัตโนมัติ",
              ok: "ตกลง"
            }
          }
        }).then(function(response) {
      ...
      .then(function(response) {
        ...
        $mdDialog.show({
          ...
          locals: {
            displayOption: {
              title: "เกิดข้อผิดพลาด !",
              content: "เกิดข้อผิดพลาด getGetInDetail ใน adminPaymentDetailController ระบบจะปิดอัตโนมัติ",
              ok: "ตกลง"
            }
          }
        }).then(function(response) {
