appControllers.controller('vanBookingListCtrl', function($scope, $timeout, $state, $ionicHistory, $mdDialog, $http, myService, $mdSidenav, $ionicPlatform) {
  ...
  $ionicPlatform.registerBackButtonAction(function() {
    if ($mdSidenav("left").isOpen()) {
      ...
      if ($state.current.name == 'loginvan.vanbookinglist') {
